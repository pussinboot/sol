...
class GuiPart:
	...
	def draw_grid(self,numberX=24,numberY=20):
		self.grid = []
		#self.grid.append(
		self.hline = self.canvas.create_line(10,self.height/2,
...
#
	...
	def extend_grid(self,nX=48): # major slowdown lol
		...
		current_coords = self.canvas.coords(self.hline)
		self.canvas.coords(self.hline,current_coords[0],current_coords[1],new_w,current_coords[3])
		# nX = int((self.width - 10) / numberX)
		# print(new_w % nX)
